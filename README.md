...
**Automated, High-Performance WebGIS Engine for Visualization of Real-Time Meteorological Data**
...
```
> **Note:** Ensure `requirements.txt` contains `herbie-data`, `numpy`, `xarray`, `scipy`, `matplotlib`, `toolz`, and `imageio`.
...
```
###  4. Running the pipeline manually on the terminal for tests
```
...
# or python3 pytests/test_pipeline.py depending on how Python 3 was installed
```
